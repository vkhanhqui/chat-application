...
public class ClientForm extends javax.swing.JFrame {
    ...
    private void login(LoginForm lgf) {
        try {
//            int port = Integer.parseInt(txtPort.getText());
            client = new Socket(InetAddress.getLocalHost(), 9999);
//            if (client.isConnected()) {
//                txtaChatBox.setText("connected");
//                lgf.setSocket(client);
//                lgf.setVisible(true);
//                do {
            txtaMessage.setVisible(true);
            btnSend.setVisible(true);
            DataOutputStream dos = new DataOutputStream(client.getOutputStream());
//                    dos.writeUTF("\nuser " + lgf.getTxtUserName().getText() + " is logging");
//                } while (lgf.isLogin() == true);
//            } else {
//                txtaChatBox.setText("could not connect");
//            }
    ...
    private void btnConnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConnActionPerformed
        ...
        Thread read = new ReadingThread(client, txtaChatBox, rootPane);
        read.start();
    ...
    private void btnSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendActionPerformed
        ...
        Thread write = new WritingThread(client, txtaMessage, rootPane, "Server");
        write.start();
